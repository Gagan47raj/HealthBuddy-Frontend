...
export default function Product() {
  ...
  const medicineTypeValue = searchParams.get("medicineType");
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [dispatch, priceValue, discountValue, sortValue, pageNumber, stock,categoryValue,severityValue,medicineTypeValue,searchKey]);
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900" onClick={() => navigate("/medicine")}>
              All Medicine
            </h1>
